...
// #define DEBUG_PRINT
#define DCF39_F_SHIFT_HZ (340)
#define SAMPLES_PER_SYMBOL (15)

struct _dcf39_demod_t {
  int16_t xip;
  int16_t xqp;
  int16_t ya;
  int32_t int1;
...
dcf39_demod_t* dcf39_demod_create(void) {
  dcf39_demod_t* self = calloc(1, sizeof(dcf39_demod_t));
  return self;
}
...
dcf39_decoder_t* dcf39_decoder_create(void) {
  dcf39_decoder_t* self = calloc(1, sizeof(dcf39_decoder_t));
  return self;
}
